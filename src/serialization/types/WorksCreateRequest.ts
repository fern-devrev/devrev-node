...
> = core.serialization
    .union("type", {
        issue: core.serialization.lazyObject(async () => (await import("..")).WorksCreateRequestIssue).extend(_Base),
        ticket: core.serialization.lazyObject(async () => (await import("..")).WorksCreateRequestTicket).extend(_Base),
    })
