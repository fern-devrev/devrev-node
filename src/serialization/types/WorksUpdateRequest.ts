...
const _Base = core.serialization.object({
    ...
    artifacts: core.serialization.lazyObject(async () => (await import("..")).WorksUpdateRequestArtifactIds).optional(),
...
> = core.serialization
    .union("type", {
        issue: core.serialization.lazyObject(async () => (await import("..")).WorksUpdateRequestIssue).extend(_Base),
        none: core.serialization
            .object({
                value: core.serialization.lazy(async () => (await import("..")).Empty),
            })
            .extend(_Base),
        ticket: core.serialization.lazyObject(async () => (await import("..")).WorksUpdateRequestTicket).extend(_Base),
    })
