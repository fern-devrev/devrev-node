...
export class TimelineEntries {
    ...
    public async create(request: DevRev.TimelineEntriesCreateRequest): Promise<void> {
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, "timeline-entries.create"),
            method: "POST",
            headers: {
    ...
    public async get(request: DevRev.GetTimelineRequest): Promise<DevRev.TimelineEntriesGetResponse> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, "timeline-entries.get"),
            method: "GET",
            headers: {
                Authorization: await core.Supplier.get(this.options.authorization),
            },
    ...
    public async list(request: DevRev.TimelineEntriesListRequest): Promise<DevRev.TimelineEntriesListResponse> {
        ...
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, "timeline-entries.list"),
            method: "GET",
            headers: {
                Authorization: await core.Supplier.get(this.options.authorization),
            },
    ...
    public async update(request: DevRev.TimelineEntriesUpdateRequest): Promise<DevRev.TimelineEntriesUpdateResponse> {
        const _response = await core.fetcher({
            url: urlJoin(this.options.environment, "timeline-entries.update"),
            method: "POST",
            headers: {
                Authorization: await core.Supplier.get(this.options.authorization),
            },
